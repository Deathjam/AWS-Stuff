...
def lambda_handler(event, context): 
    ...
    #    ParentId="r-oxxxx", #My Parent OU. Change for your environment 
    #    Name=ouName 
    # ) 
    ...
    RootID = 'r-oxxx' 
    # Set Clients OU 
    OUID = 'ou-oxxx-xxxxxxx' 
 
    # Create a new Account in the OU 
    ...
    while True: 
        ...
        if str(createStatus['CreateAccountStatus']['State']) != 'IN_PROGRESS': 
            newAccountId = str( 
                createStatus['CreateAccountStatus']['AccountId']) 
            break 
    ...
    # Set Return Data 
    # If you need to return data use this json object 
    responseData = {"Message": newAccountId} 
